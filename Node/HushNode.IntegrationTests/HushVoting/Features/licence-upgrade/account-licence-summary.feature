@HushVoting @HV-E2E @E2E @HV-LICENCE-UPGRADE @HV-FEAT-017
@FEAT-017
Feature: Account licence summary and upgrade entry journeys
  ...
  @EPIC-002 @AT-LIC-001 @Playwright @server-fixture
  ...
  @EPIC-002 @AT-LIC-004 @Playwright @server-fixture
  ...
  @EPIC-002 @AT-LIC-005 @Playwright @server-fixture
  ...
  @EPIC-002 @AT-LIC-008 @Playwright @server-fixture
