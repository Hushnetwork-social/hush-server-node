...
public class HushVotingPackageVerifierTamperTests
{
    public static TheoryData<string, string, string, VerificationCheckStatus, VerificationOverallStatus, int> TamperFixtures =>
        new()
        {
            ...
            { "missing-sp07-development-warning", VerificationProfileIds.DevelopmentCurrentV1, VerificationResultCodes.PublicationProofNotRequiredForDevelopment, VerificationCheckStatus.Pass, VerificationOverallStatus.Pass, 0 },
