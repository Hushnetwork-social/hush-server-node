...
public static class Program
{
    public static int Main(string[] args)
    {
        try
        {
            ...
            var paths = RetentionLogPrivacyRecurringScanPromotionPaths.FromWorkspaceRoot(workspaceRoot);
            var result = new RetentionLogPrivacyRecurringScanPromotionService().Promote(new(
                paths,
                mode,
                sourceInput,
                outputRoot,
        ...
        catch (RetentionLogPrivacyRecurringScanPromotionException ex)
        {
