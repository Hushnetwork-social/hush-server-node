...
public static class Program
{
    public static int Main(string[] args)
    {
        try
        {
            ...
            var paths = DisputeContinuityReadinessPromotionPaths.FromWorkspaceRoot(workspaceRoot);
            var result = new DisputeContinuityReadinessPromotionService().Promote(new(
                paths,
                mode,
                sourceInput,
                outputRoot,
        ...
        catch (DisputeContinuityReadinessPromotionException ex)
        {
