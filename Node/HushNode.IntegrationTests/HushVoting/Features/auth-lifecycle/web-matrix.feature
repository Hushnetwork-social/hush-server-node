@HushVoting @HV-E2E @E2E @HV-AUTH-LIFECYCLE @HV-FEAT-010
@FEAT-010
Feature: HushVoting real-root Web acceptance matrix — FEAT-010
  ...
  Scenario: A child flow cannot grant protected access without fresh exact verification
    ...
    And only a repaired exact profile and fresh password unlock complete root authentication
  ...
  @FEAT-010 @AC-010-089 @AC-010-097 @HV-AUTH-SECURITY-001 @HV-ARTIFACT-PRIVACY
