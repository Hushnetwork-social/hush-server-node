...
public sealed class LicenceCacheArchitectureTests
{
    ...
    public void Cache_assembly_public_surface_is_closed()
    {
        ...
        publicTypes.Should().BeEquivalentTo(new[]
        {
            ...
            "HushNode.HushVoting.Licensing.Cache.ICurrentLicenceCatalogueProvider",
            "HushNode.HushVoting.Licensing.Cache.IEntitlementAuthorityResolver",
            "HushNode.HushVoting.Licensing.Cache.IEntitlementProjectionStore",
            "HushNode.HushVoting.Licensing.Cache.ILicenceCacheOutboxDispatcher",
            "HushNode.HushVoting.Licensing.Cache.ILicenceCacheOutboxStore",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheCircuitBreaker",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheCircuitBreaker+CircuitState",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheEnvelopeCodec",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheHealth",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheHealthState",
            ...
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheOutboxBackoffCalculator",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheOutboxDispatcherService",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheOutboxLeaseOwnership",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheOutboxStore",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheOutboxWorker",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheReasonCodes",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheRedisWriter",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheReadinessResult",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheRuntimeMode",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheRuntimeStatus",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheSingleFlight",
            "HushNode.HushVoting.Licensing.Cache.LicenceCacheTelemetry",
            ...
            "HushNode.HushVoting.Licensing.Cache.StoreWriteResult",
        });
    }
