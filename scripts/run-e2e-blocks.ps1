...
$allBlocks = @(
    ...
    @{ Name = "HV-E2E-FEAT-159"; Filter = 'Category=HV-E2E-FEAT-159&Category!=LONG_RUNNING' },
    ...
    @{ Name = "HS-E2E-091-NOTIFICATIONS"; Filter = 'Category=HS-E2E-091-NOTIFICATIONS&Category!=LONG_RUNNING' }
)
