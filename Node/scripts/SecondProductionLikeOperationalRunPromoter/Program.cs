...
public static class Program
{
    public static int Main(string[] args)
    {
        try
        {
            ...
            var paths = SecondProductionLikeOperationalRunPromotionPaths.FromWorkspaceRoot(workspaceRoot);
            var result = new SecondProductionLikeOperationalRunPromotionService().Promote(new(
                paths,
                mode,
                sourceInput,
                outputRoot,
        ...
        catch (SecondProductionLikeOperationalRunPromotionException ex)
        {
