...
public static class Program
{
    public static int Main(string[] args)
    {
        try
        {
            ...
            var paths = DisputeContinuityMatrixPromotionPaths.FromWorkspaceRoot(workspaceRoot);
            var result = new DisputeContinuityMatrixPromotionService().Promote(new(
                paths,
                mode,
                sourceInput,
                outputRoot,
        ...
        catch (DisputeContinuityMatrixPromotionException ex)
        {
