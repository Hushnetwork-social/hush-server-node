...
public static class Program
{
    public static int Main(string[] args)
    {
        try
        {
            ...
            var paths = GovernedOutcomeProducerPaths.FromWorkspaceRoot(workspaceRoot);
            var result = new GovernedOutcomeProducerPromotionService().Promote(new(
                paths,
                mode,
                sourceInput,
                outputRoot,
        ...
        catch (GovernedOutcomeProducerException ex)
        {
