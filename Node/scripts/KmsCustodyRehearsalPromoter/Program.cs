...
public static class Program
{
    public static int Main(string[] args)
    {
        try
        {
            ...
            var paths = KmsCustodyRehearsalPromotionPaths.FromWorkspaceRoot(workspaceRoot);
            var result = new KmsCustodyRehearsalPromotionService().Promote(new(
                paths,
                mode,
                sourceInput,
                outputRoot,
        ...
        catch (KmsCustodyRehearsalPromotionException ex)
        {
