...
public static class Program
{
    public static int Main(string[] args)
    {
        try
        {
            ...
            var paths = VoidDecisionReadinessPromotionPaths.FromWorkspaceRoot(workspaceRoot);
            var result = new VoidDecisionReadinessPromotionService().Promote(new(
                paths,
                mode,
                sourceInput,
                outputRoot,
        ...
        catch (VoidDecisionReadinessPromotionException ex)
        {
