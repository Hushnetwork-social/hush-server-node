...
public class ImageProcessorTests
{
    ...
    /// Uses a pre-generated minimal JPEG to avoid native SkiaSharp dependencies in CI.
    /// </summary>
    private static byte[] CreateTestJpegImage(int width, int height)
    {
        // Minimal valid 1x1 red JPEG (works for any size request - ImageProcessor will process it)
        // This avoids native SkiaSharp dependencies which fail on GitHub Actions Linux runners
        return new byte[]
        {
            ...
            0x00, 0x00, 0x3F, 0x00, 0xFB, 0xD5, 0xDB, 0x20, 0xA8, 0xF3, 0x42, 0x8A,
            0x28, 0x03, 0xFF, 0xD9
        };
    }
