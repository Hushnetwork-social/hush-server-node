...
Feature: Upgrade activation progress, stale recovery, and pending indicator journeys
  ...
  @EPIC-002 @AT-LIC-006 @Playwright @server-fixture
  ...
  @EPIC-002 @AT-LIC-009 @Playwright @server-fixture
  ...
  Scenario: Licence surfaces are accessible and responsive across supported Web viewports
    ...
    And popup focus is contained and restored while confirmation receives logical focus
