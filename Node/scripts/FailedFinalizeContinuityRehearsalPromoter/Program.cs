...
public static class Program
{
    public static int Main(string[] args)
    {
        try
        {
            ...
            var paths = FailedFinalizeContinuityPromotionPaths.FromWorkspaceRoot(workspaceRoot);
            ...
            Console.WriteLine($"Score change allowed: {result.GeneratedPackage.GateEvaluation.ScoreChangeAllowed}");
            Console.WriteLine($"Downstream handoff: {result.GeneratedPackage.GateEvaluation.DownstreamHandoffStatus}");
        ...
        catch (FailedFinalizeContinuityPromotionException ex)
        {
