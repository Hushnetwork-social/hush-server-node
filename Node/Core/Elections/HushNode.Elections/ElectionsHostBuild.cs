...
public static class ElectionsHostBuild
{
    ...
    public static void RegisterElectionsCoreServices(this IServiceCollection services)
    {
        ...
        services.AddTransient<ITransactionContentHandler, CreateElectionDraftContentHandler>();
        services.AddTransient<ITransactionContentHandler, UpdateElectionDraftContentHandler>();
        services.AddTransient<ITransactionContentHandler, InviteElectionTrusteeContentHandler>();
        services.AddTransient<ITransactionContentHandler, RevokeElectionTrusteeInvitationContentHandler>();
        services.AddTransient<ITransactionContentHandler, StartElectionGovernedProposalContentHandler>();
        services.AddTransient<ITransactionContentHandler, ApproveElectionGovernedProposalContentHandler>();
        services.AddTransient<ITransactionContentHandler, RetryElectionGovernedProposalExecutionContentHandler>();
        services.AddTransient<ITransactionContentHandler, OpenElectionContentHandler>();
        services.AddTransient<ITransactionContentHandler, CloseElectionContentHandler>();
        services.AddTransient<ITransactionContentHandler, FinalizeElectionContentHandler>();
